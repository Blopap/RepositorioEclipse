...
public class Modelos implements java.io.Serializable{
	...
	public Modelos(ArrayList<Modelo> listadoModelos) {
	...
	public void altaModelo()
	{
		...
		pvp = entrada.nextFloat();//Lee pvp
		
		if(Rutinas.leeBooleano("Desea añadir un modelo con promocion?"))//Pregunta si se desea crear un modelo con promocion
		{
			System.out.println("Introduzca el descuento en porcentaje(%)");
			descuento=entrada.nextFloat();//Lee el descuento

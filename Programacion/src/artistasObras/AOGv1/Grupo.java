...
public class Grupo implements java.io.Serializable{
	...
	public void mostrarIdsArtistas()
	{
		for(int i=0; i<this.getArtistas().size();i++ ) //Muestra una lista de los identificadores de los artistas del grupo
		{
			System.out.print(this.getArtistas().get(i).getIdArtista()+" ");
		}
		System.out.println();
	}
	public void mostrarIdsObras()
	{
		for(int i=0; i<this.getObras().size();i++ ) //Muestra una lista de los identificadores de los artistas del grupo
		{
			System.out.print(this.getObras().get(i).getIdObra()+" ");
		}
		System.out.println();
	}
